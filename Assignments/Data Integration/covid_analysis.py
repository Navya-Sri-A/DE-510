...
Original file is located at
    https://colab.research.google.com/drive/1icrTXX4ui7trLYDkI1yX3DNQe0K2i-UT
"""
...
print(f"The columns on Covid Cases dataframe are : {cases_df.columns}")
print(f"The columns on Covid Deaths dataframe are : {deaths_df.columns}")
print(f"The columns on Covid Census dataframe are : {census_df.columns}")
...
print("The cases in Washington County are :", len(washington_cases))

washington_deaths = deaths_df[deaths_df["County Name"] == "Washington County"]
print("The deaths in Washington County are :", len(washington_deaths))
...
print(f"The total no. of rows in cases_df :", len(cases_df))
print(f"The total no. of rows in deaths_df :", len(deaths_df))
...
print(f"The columns on Covid Cases dataframe are : {cases_df.columns.values.tolist()}")
print(f"The columns on Covid Deaths dataframe are : {deaths_df.columns.values.tolist()}")
...
print(f"The total no. of rows after performing the join on join_df are : {len(join_df)}")

correlation_matrix = join_df.corr(numeric_only=True)
print(f"The correlation matrix among the numeric columns of join_df using DataFrame.corr() is : \n{correlation_matrix}")
